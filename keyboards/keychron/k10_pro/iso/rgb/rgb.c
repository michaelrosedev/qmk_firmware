...
led_config_t g_led_config = {
    {
        ...
        {     62,     63,     64,     65,     66,     67,     68,     69,     70,    71,     72,     73,     74, NO_LED, NO_LED, NO_LED,     75,     76,     77, NO_LED },
        {     78,     79,     80,     81,     82,     83,     84,     85,     86,    87,     88,     89, NO_LED,     90, NO_LED,     91, NO_LED,     92,     93,     94,     95 },
        {     96,     97,     98, NO_LED, NO_LED,     99, NO_LED, NO_LED,    100,   101,    102,    103,    104,    105,    106,    107,    108, NO_LED }
    },
    {
        {0, 0},          {22, 0}, {33, 0}, {44, 0}, {55,  0}, {68,  0}, {79, 0},  {90,  0}, {101, 0}, {114, 0}, {125, 0}, {136, 0}, {147, 0}, {160, 0}, {171, 0}, {182,  0}, {194,  0}, {205,  0}, {216,  0}, {224,  0},
        {0,15}, {11,15}, {22,15}, {33,15}, {44,15}, {55, 15}, {66, 15}, {77, 15}, {88, 15}, {99, 15}, {110,15}, {125,15}, {136,15}, {152,15}, {160,15}, {171,15}, {182, 15}, {194, 15}, {205, 15}, {216, 15}, {224, 15},
        {2,28}, {15,28}, {26,28}, {37,28}, {48,28}, {59, 28}, {70, 28}, {81, 28}, {93, 28}, {104,28}, {115,28}, {126,28}, {137,28}, {148,28}, {160,28}, {171,28}, {182, 28}, {194, 28}, {205, 28}, {216, 28}, {224, 28},
        {3,39}, {17,39}, {28,39}, {39,39}, {50,39}, {61, 39}, {72, 39}, {83, 39}, {94, 39}, {105,39}, {116,39}, {127,39}, {138,39},                               {182, 39}, {194, 39}, {205, 39},
        {0,52}, {10,52}, {21,52}, {32,52}, {43,52}, {54, 52}, {65, 52}, {76, 52}, {87, 52}, {98, 52}, {109,52}, {120,52},           {134,52},           {171,52},            {194, 52}, {205, 52}, {216, 52}, {224, 52},
        {1,64}, {12,64}, {24,64},                   {65, 64},                     {89, 64}, {101,64}, {113,64}, {125,64}, {160,64}, {171,64}, {182,64}, {200,64}, {216,64},
    },
    {
...
// this is not quite right for the ISO layout
// led_config_t g_led_config = {
//     {
